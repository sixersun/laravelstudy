...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('/vendor/horizon/img/favicon.png')); ?>">

    <title>Horizon<?php echo e(config('app.name') ? ' - ' . config('app.name') : ''); ?></title>

    <!-- Style sheets-->
    <link href="https://fonts.googleapis.com/css?family=Nunito" rel="stylesheet">
    <link href="<?php echo e(asset(mix($cssFile, 'vendor/horizon'))); ?>" rel="stylesheet">
</head>
<body>
<div id="horizon" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-2"><strong>Laravel</strong> Horizon<?php echo e(config('app.name') ? ' - ' . config('app.name') : ''); ?></h4>
...
<script>
    window.Horizon = <?php echo json_encode($horizonScriptVariables, 15, 512) ?>;
</script>

<script src="<?php echo e(asset(mix('app.js', 'vendor/horizon'))); ?>"></script>
</body>
</html>
<?php /**PATH D:\phpstudy\WWW\laravelstudy\vendor\laravel\horizon\src/../resources/views/layout.blade.php ENDPATH**/ ?>