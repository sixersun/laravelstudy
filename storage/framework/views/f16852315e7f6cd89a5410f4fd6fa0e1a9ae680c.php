	...
	<div id="mobile_menu_wrapper">
		<ul id="mobile_menu">
			<?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php echo $__env->make('administrator::partials.menu_item', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</header><?php /**PATH D:\phpstudy\WWW\laravelstudy\vendor\summerblue\administrator\src\Frozennode\Administrator/../../views/partials/header.blade.php ENDPATH**/ ?>